...
let refreshDOMTable = () => {  
    ...
    let enableDisableNewUserModal = (option) => {
        ...
        let newEmailAddress = document.getElementById('newEmailAddress');
        newPersonName.value = '';
    ...
    newPersonSubmitBtn.addEventListener('click', () => {
        ...
        let newEmailAddress = document.getElementById('newEmailAddress').value.trim();
        ...
        if(newEmailAddress === '')
            document.getElementById('newEmailAddress').className = 'input-err';
        else 
            document.getElementById('newEmailAddress').className = ''; 
            
        if(newPersonName !== '' && newPersonPhone !== '' && newEmailAddress !== '' ) {
            let newPerson = {};
    ...
    for(let i = 0; i < editBtns.length; i++) {
        editBtns[i].addEventListener('click', ($event) => {
            ...
            newEmailAddress.value = personToEdit.address; 
